...
# 导入数据集和模型
from noisedata_copy import LineOctavedata  # 假设数据集类在noisedata.py中
from soundmodel_copy import LineOctaveModel  # 假设多分枝模型在model.py中
...
def train_epoch(model, dataloader, criterion, optimizer, device, epoch, writer):
    ...
    for batch_idx, (inputs, targets) in enumerate(pbar):
        ...
        # outputs = outputs[batch_size, :].squeeze(1)

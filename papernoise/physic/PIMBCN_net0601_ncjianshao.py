...
class HighFidelityTaskHead(nn.Module):
    def __init__(self, freq_bins=2501):
        ...
        self.refine = nn.Sequential(
            ...
            nn.LayerNorm([8, 2048]),  # LayerNorm 在小样本更稳定
            nn.GELU(),
            nn.Dropout1d(0.3),  # 提升 Dropout
        ...
        self.broadband_path = nn.Sequential(
            nn.Conv1d(4, 2, kernel_size=7, padding=3),
            nn.GELU(),

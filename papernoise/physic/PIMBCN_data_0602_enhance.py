...
class PIMBCNDataset(Dataset):
    def __init__(self, directory_path, input_cols=[4, 5, 6],
        ...
        # 频率轴（用于频谱增强）
        self.freq_axis = np.linspace(20, 10000, 2501)
    ...
    def _augment_spectrum(self, spectrum, original_oaspl):
        """对频谱数据进行增强"""
        ...
        oaspl_scale = original_oaspl / new_oaspl
    ...
    def __getitem__(self, idx):
        ...
        if self.augment and not self.is_validation:
            ...
            spectrum = self._augment_spectrum(spectrum, self.oaspl_array[data_idx])
